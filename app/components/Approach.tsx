...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card lg:h-[35rem] rounded-3xl flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative h-[30rem] relative"
    >
...
const AceternityIcon = ({ order }: {order: string}) => {
  ...
  <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full text-2xl bg-slate-950 px-5 py-2 font-bold text-white backdrop-blur-3xl">
    {order}
  </span>
</button>
   </div>
